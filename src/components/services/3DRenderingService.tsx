          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              <h2 className="text-3xl lg:text-4xl font-bold mb-4">
                Our 3D Rendering <span className="text-purple-400">Services</span>
              </h2>
              <p className="text-gray-400 max-w-2xl mx-auto">
                Professional 3D visualization services that transform concepts into photorealistic renderings.
              </p>
            </motion.div>
