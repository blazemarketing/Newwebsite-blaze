          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              <h2 className="text-3xl lg:text-4xl font-bold mb-4">
                Our Web Development <span className="text-emerald-400">Services</span>
              </h2>
              <p className="text-gray-400 max-w-2xl mx-auto">
                Comprehensive web development solutions that combine cutting-edge technology with exceptional user experience.
              </p>
            </motion.div>
