          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              <h2 className="text-3xl lg:text-4xl font-bold mb-4">
                Our AI-Powered SEO <span className="text-green-400">Services</span>
              </h2>
              <p className="text-gray-400 max-w-2xl mx-auto">
                Comprehensive SEO services powered by advanced AI and machine learning to dominate search rankings.
              </p>
            </motion.div>
